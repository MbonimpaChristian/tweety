   ...
   <div class="container-fluid">
    ...
    <div class="col-md-4 offset-md-1">
        <div class="col-right">
            ...
            <h2 class="text-center" style="font-family:-apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Oxygen, Ubuntu, Cantarell, 'Open Sans', 'Helvetica Neue', sans-serif"><b>SIGN IN</b></h2>
            <form action="{{route('login')}}" method="POST">
                ...
                <p class="text-center"><a href="{{route('register')}}" style="text-decoration: none">Not registered Yet?</a></p>
              </form>
        </div>
     </div>
     <!--sign up Modal-->
